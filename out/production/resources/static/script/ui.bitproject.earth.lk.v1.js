...
function comboBox2(parent,id,lblText,labelWidth,ob,prop,oldob,labeladdnew=null,addnew=null){
    ...
    label.classList.add('col-md-'+labelWidth);
    var fieldArea = createElement('div');
    fieldArea.classList.add('col-md-'+(10-labelWidth));
    var field = createElement('select',id);
    field.classList.add('form-control');
    field.setAttribute('data-object',ob);
    field.setAttribute('data-oldobject',oldob);
    ...
    if(labeladdnew!=null){
        var bt = createElement('div',id+'addnew');
        bt.innerHTML = labeladdnew;
        bt.classList.add('btn');
        bt.classList.add('btn-default');
        // bt.classList.add('col-md-2');
        bt.style.width="13%";
        bt.onclick = function chnagePageSize() { addnew();  };
        formGroup.appendChild(bt);
    }
